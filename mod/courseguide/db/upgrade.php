...
/**
 * This file keeps track of upgrades to the courseguide module
 *
...
/**
 * Execute courseguide upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_courseguide_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the courseguide
     * iself has been upgraded.
     *
     * For each upgrade block, the file courseguide/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        // Define field intro to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        // Define field introformat to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'courseguide');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        // Define field timemodified to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        // Define index course (not unique) to be added to courseguide.
        $table = new xmldb_table('courseguide');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'courseguide');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'courseguide');
    }

    if ($oldversion < 2017051201) {

        // Define table courseguide to be created.
        $table = new xmldb_table('courseguide');

        // Adding fields to table courseguide.
        ...
        // Adding keys to table courseguide.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));

        // Adding indexes to table courseguide.
        $table->add_index('course', XMLDB_INDEX_NOTUNIQUE, array('course'));

        // Conditionally launch create table for courseguide.
        if (!$dbman->table_exists($table)) {
            $dbman->create_table($table);
        }

        // Courseguide savepoint reached.
        upgrade_mod_savepoint(true, 2017051201, 'courseguide');
    }

    if ($oldversion < 2017081700) {

        // Define field cancomplete to be added to block_mdrtr_guide_templates.
        $table = new xmldb_table('mod_courseguide_templates');
        $field = new xmldb_field('cancomplete', XMLDB_TYPE_INTEGER, '1', null, null, null, '0', 'defaultdisplaymode');
        ...
        $table = new xmldb_table('mod_courseguide_guides');
        $field = new xmldb_field('completed', XMLDB_TYPE_INTEGER, '1', null, null, null, '0', 'displaymode');
        ...
        // Courseguide savepoint reached.
        upgrade_mod_savepoint(true, 2017081700, 'courseguide');
    }
