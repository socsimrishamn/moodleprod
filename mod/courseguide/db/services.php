...
$functions = [
    'mod_courseguide_get_guides_courses' => [
        'classname'     => 'mod_courseguide\\webservice\\external',
        'methodname'    => 'get_guides_courses',
        'description'   => 'Return the course guides sorted by courses. It can be filtered by organisation. 
